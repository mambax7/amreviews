    ...
    public static function getFileStatus($file_path, $original_file_path = null, $redirectFile)
    {
        ...
        if (null === $original_file_path) {
            if (self::fileExists($file_path)) {
                ...
                $path_status .= "$file_path (" . $lang::AVAILABLE . ') ';
            } else {
                $path_status = "<img src='$pathIcon16/0.png' >";
                $path_status .= "$file_path (" . $lang::NOTAVAILABLE . ') ';
            }
        } else {
            if (self::compareFiles($file_path, $original_file_path)) {
                ...
                $path_status .= "<button class='submit' onClick='this.form.submit();'>" . $lang::CREATETHEFILE . '</button>';
                $path_status .= '</form>';
            }
        }
...
switch ($op) {
    case 'copyfile':
        ...
        $msg = FileChecker::copyFile($original_file_path, $file_path) ? $lang::FILECOPIED : $lang::FILENOTCOPIED;
