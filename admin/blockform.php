...
$form->addElement(new \XoopsFormText($lang::WEIGHT, 'bweight', 2, 5, $block['weight']));
$form->addElement(new \XoopsFormRadioYN($lang::VISIBLE, 'bvisible', $block['visible']));
$mod_select = new \XoopsFormSelect($lang::VISIBLEIN, 'bmodule', $block['modules'], 5, true);
...
$form->addElement(new \XoopsFormText($lang::TITLE, 'btitle', 50, 255, $block['title']), false);
if ($block['is_custom']) {
