...
if ($GLOBALS['xoopsUser']->isAdmin($xoopsModule->mid())) {
    ...
    */
    ...
    function listBlocks()
    {
        ...
        ksort($module_list);
        echo "
        <h4 style='text-align:left;'>" . $lang::BADMIN . '</h4>';
        $moduleHandler = xoops_getHandler('module');
    ...
    function cloneBlock($bid)
    {
        ...
        $block     = [
            ...
            'form_title' => $lang::BLOCKS_CLONEBLOCK,
        ...
        echo '<a href="blocksadmin.php">' . $lang::BADMIN . '</a>&nbsp;<span style="font-weight:bold;">&raquo;&raquo;</span>&nbsp;' . _AM_SYSTEM_BLOCKS_CLONEBLOCK . '<br><br>';
    ...
    function editBlock($bid)
    {
        ...
        $block     = [
            ...
            'form_title' => $lang::BLOCKS_EDITBLOCK,
            //        'name'       => $myblock->getVar('name'),
            'side'       => $myblock->getVar('side'),
            'weight'     => $myblock->getVar('weight'),
            'visible'    => $myblock->getVar('visible'),
        ...
        echo '<a href="blocksadmin.php">' . $lang::BADMIN . '</a>&nbsp;<span style="font-weight:bold;">&raquo;&raquo;</span>&nbsp;' . _AM_SYSTEM_BLOCKS_EDITBLOCK . '<br><br>';
        require_once __DIR__ . '/blockform.php';
        $form->display();
        //        xoops_cp_footer();
        require_once __DIR__ . '/admin_footer.php';
    ...
    function updateBlock($bid, $btitle, $bside, $bweight, $bvisible, $bcachetime, $bmodule, $options, $groups)
    {
        ...
        redirect_header($_SERVER['PHP_SELF'], 1, $lang::UPDATE_SUCCESS);
    }
